...
PICS = (environ.get('PICS' ,'https://telegra.ph/file/2ae90e410284fd3f83c2b.jpg')).split()
BOT_START_TIME = time()
...
START_MESSAGE = environ.get('START_MESSAGE', '👋 𝙷𝙴𝙻𝙾 {user}\n\n𝙼𝚈 𝙽𝙰𝙼𝙴 𝙸𝚂 {bot},\n𝙸 𝙲𝙰𝙽 𝙿𝚁𝙾𝚅𝙸𝙳𝙴 𝙼𝙾𝚅𝙸𝙴𝚂, 𝙹𝚄𝚂𝚃 𝙰𝙳𝙳 𝙼𝙴 𝚃𝙾 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿 𝙰𝙽𝙳 𝙼𝙰𝙺𝙴 𝙼𝙴 𝙰𝙳𝙼𝙸𝙽 𝙸𝙵 𝙰𝙽𝚈 𝙿𝚁𝙾𝙱𝙻𝙴𝙼 𝙸𝚂 𝚃𝙷𝙴𝚁𝙴 𝙿𝙻𝚂 𝚁𝙴𝙿𝙾𝚁𝚃 𝚃𝙾 @KOMASSISTANTBOT')
