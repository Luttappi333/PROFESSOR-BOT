...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            ...
            InlineKeyboardButton("📢 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 📢", url="https://t.me/KOMBOTZZ")
            ],[
            InlineKeyboardButton("🎥 ᴍᴏᴠɪᴇ ᴜᴘᴅᴀᴛᴇs", url="https://t.me/kom_links")
            ],[      
        ...
        buttons = [[
            InlineKeyboardButton('SOURCE CODE', url='https://t.me/LUTTAPPIxTG')
            ],[
